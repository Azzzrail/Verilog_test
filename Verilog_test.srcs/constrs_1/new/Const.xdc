...
#set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { enable }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
...
#set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { output1 }]; #IO_L24N_T3_35 Sch=led[4]
#set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { output2 }]; #IO_25_35 Sch=led[5]
#set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { output3 }]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { output4 }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]

##Buttons

#set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { input }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { output3 }]; #IO_0_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { ja[1] }]; #IO_L4P_T0_15 Sch=ja[2]
#set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { output2 }]; #IO_L4N_T0_15 Sch=ja[3]
...
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { Beam_input }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
...
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { output3_gnd }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
...
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { output1 }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
...
#set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { output1_gnd }]; #IO_L23P_T3_A03_D19_14 Sch=jc_p[4]
